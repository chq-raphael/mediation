...
<body>
	...
	<div class="uc_tjTitle">
		<a href="<?php echo App_URL;?>/index.php?act=index&op=tiaojieing">正在调解(<?php echo $tjcount_ing; ?>)</a>
		<a href="#"  class="active">历史调解(<?php echo $tjcount_end; ?>)</a>
	</div>
	<ul class="uc_tjList">
	<?php
            ...
            ?>
		<li>
			<a href="<?php echo App_URL;?>/index.php?act=index&op=complete&id=<?php echo $item['mediatorEvaluationId']; ?>">
				<div class="title">
				...
				<div class="label">
					<span class="st"><?PHP echo $item['departmentName']; ?></span>
					<span class="user"><?PHP echo $item['mediaName']; ?></span>
					<span class="goIng" >已完成</span>
					<?php
